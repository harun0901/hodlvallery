...
import {binance, coinInjection, fortmatic, injected, portis, walletconnect, walletlink} from '../connectors'
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo } = {
  ...
  COIN_WALLET: {
    connector: coinInjection,
    name: 'Coin Wallet',
    iconName: 'coin-wallet.png',
    description: 'Best cross chain wallet',
    href: null,
    color: '#E8831D',
  },
  METAMASK: {
